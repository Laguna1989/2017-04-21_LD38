...
class IntroState extends FlxState
{
	...
	public override function create()
	{
		...
		FlxTween.tween(logo, { y: -280/2 }, 0.45, { startDelay:0.5 , ease:FlxEase.circIn , onComplete:function(t) { FlxG.camera.shake(0.005, 0.125); }  } );
		FlxTween.tween(logo, { y: -140/2 }, 0.50, { startDelay:0.96, ease:FlxEase.circIn , onComplete:function(t) { FlxG.camera.shake(0.010, 0.15); }   } );
